 ...
 * the License.
 */
package com.zgcenv.plus.engine;
...
public abstract class AbstractTemplateEngine {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(com.baomidou.mybatisplus.generator.engine.AbstractTemplateEngine.class);
    /**
     * 配置信息
     */
